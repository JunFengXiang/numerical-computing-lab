...
原书 PDF 页 155；印刷页码 142。

\href{source-images/pdf-155.jpeg}{原页}

\section{第 6 章 方程求根}\label{ch06-ux7b2c-6-ux7ae0-ux65b9ux7a0bux6c42ux6839}

\subsection{6.1 根的搜索}\label{ch06-ux6839ux7684ux641cux7d22}
...
\subsubsection{6.1.1 逐步搜索法}\label{ch06-ux9010ux6b65ux641cux7d22ux6cd5}
...
\subsubsection{6.1.2 二分法}\label{ch06-ux4e8cux5206ux6cd5}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 6.1 原扫描裁切}]{verified/assets/ch06/fig-6.1.png}
...
\begin{quote}
校注（agent 补充）：原页例 6.2 引用了``误差估计式（6.1.1）''，但本页对应的误差估计式旁未见印刷编号。此处保留原文引用及无编号公式，不补造公式标签；见 \href{verified/assets/ch06/detail-p156-audit.png}{误差估计式原图裁切}。
\end{quote}

\clearpage

原书 PDF 页 157；印刷页码 144。
...
\subsection{6.2 迭代法}\label{ch06-ux8fedux4ee3ux6cd5}

\subsubsection{6.2.1 迭代过程的收敛性}\label{ch06-ux8fedux4ee3ux8fc7ux7a0bux7684ux6536ux655bux6027}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 6.2 原扫描裁切}]{verified/assets/ch06/fig-6.2.png}
...
\subsubsection{6.2.2 迭代公式的加工}\label{ch06-ux8fedux4ee3ux516cux5f0fux7684ux52a0ux5de5}

对于收敛的迭代过程，只要迭代足够多次，就可以使结果达到任意的精度，但有时迭代过程收敛缓慢，从而使计算量变得很大，因此迭代过程的加速是个重要的课题。

\clearpage

原书 PDF 页 161；印刷页码 148。
...
\subsection{6.3 Newton 法}\label{ch06-newton-ux6cd5}

\subsubsection{6.3.1 Newton 公式}\label{ch06-newton-ux516cux5f0f}
...
\subsubsection{6.3.2 Newton 法的几何解释}\label{ch06-newton-ux6cd5ux7684ux51e0ux4f55ux89e3ux91ca}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 6.3 原扫描裁切}]{verified/assets/ch06/fig-6.3.png}
...
\subsubsection{6.3.3 Newton 法的局部收敛性}\label{ch06-newton-ux6cd5ux7684ux5c40ux90e8ux6536ux655bux6027}
...
\subsubsection{6.3.4 Newton 法应用举例}\label{ch06-newton-ux6cd5ux5e94ux7528ux4e3eux4f8b}
...
\begin{quote}
校注（agent 补充）：原页步 4 的替换三元组印为 \((x_1,f_1,f')\)，第三项未印下标 \(1\)，转录保留原式。结合步 2 的定义及被替换的 \(f'_0\)，这里疑应为 \(f'_1\)。这是原扫描上的疑似漏印，非 OCR 改写；局部原图见 \href{verified/assets/ch06/detail-p165-step4.png}{步 4 裁切}。
\end{quote}
...
\subsubsection{6.3.5 Newton 下山法}\label{ch06-newton-ux4e0bux5c71ux6cd5}

前面已经讨论过 Newton 法的局部收敛性。一般来说，Newton 法的收敛性依赖

\clearpage

原书 PDF 页 167；印刷页码 154。
...
\subsection{6.4 弦截法与抛物线法}\label{ch06-ux5f26ux622aux6cd5ux4e0eux629bux7269ux7ebfux6cd5}
...
\subsubsection{6.4.1 弦截法}\label{ch06-ux5f26ux622aux6cd5}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 6.4 原扫描裁切}]{verified/assets/ch06/fig-6.4.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 6.5 原扫描裁切}]{verified/assets/ch06/fig-6.5.png}
...
\subsubsection{6.4.2 抛物线法}\label{ch06-ux629bux7269ux7ebfux6cd5}
...
原书 PDF 页 170；印刷页码 157。

\href{source-images/pdf-170.jpeg}{原页}

代过程称为抛物线法。在几何图形上，这种方法的基本思想是用抛物线 \(y=P_2(x)\) 与 \(x\) 轴的交点 \(x_{k+1}\) 作为所求根 \(x^*\) 的近似位置（见图 6.6）。

\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 6.6 原扫描裁切}]{verified/assets/ch06/fig-6.6.png}
...
\subsection{6.5 代数方程求根}\label{ch06-ux4ee3ux6570ux65b9ux7a0bux6c42ux6839}

如果 \(f(x)\) 是多项式，则 \(f(x)=0\) 特别地称为代数方程。前面介绍的求根方法原则上也适用于解代数方程，但由于多项式的特殊性，可以针对其特点提供更为有效的算法。

\subsubsection{6.5.1 多项式求值的秦九韶算法}\label{ch06-ux591aux9879ux5f0fux6c42ux503cux7684ux79e6ux4e5dux97f6ux7b97ux6cd5}
...
\subsubsection{6.5.2 代数方程的 Newton 法}\label{ch06-ux4ee3ux6570ux65b9ux7a0bux7684-newton-ux6cd5}
...
原书 PDF 页 173；印刷页码 160。

\href{source-images/pdf-173.jpeg}{原页}

\subsubsection{6.5.3 劈因子法}\label{ch06-ux5288ux56e0ux5b50ux6cd5}
...
原书 PDF 页 175；印刷页码 162。

\href{source-images/pdf-175.jpeg}{原页}

\subsection{小结}\label{ch06-ux5c0fux7ed3}
...
\subsection{习题}\label{ch06-ux4e60ux9898}
