...
原书 PDF 页 261；印刷页码 248。

\href{source-images/pdf-261.jpeg}{原页}

\section{下篇　高效算法设计}\label{ch10-ux4e0bux7bc7-ux9ad8ux6548ux7b97ux6cd5ux8bbeux8ba1}

\section{*第 10 章　快速算法设计：快速 Walsh 变换}\label{ch10-ux7b2c-10-ux7ae0-ux5febux901fux7b97ux6cd5ux8bbeux8ba1ux5febux901f-walsh-ux53d8ux6362}

\subsection{10.1　美的 Walsh 函数}\label{ch10-ux7f8eux7684-walsh-ux51fdux6570}
...
\subsubsection{10.1.1　微积分的逼近法}\label{ch10-ux5faeux79efux5206ux7684ux903cux8fd1ux6cd5}
...
\subsubsection{10.1.2　Walsh 函数的复杂性}\label{ch10-walsh-ux51fdux6570ux7684ux590dux6742ux6027}
...
原书 PDF 页 263；印刷页码 250。

\href{source-images/pdf-263.jpeg}{原页}

\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.1（原图裁切）：前 16 个 Walsh 函数的波形}]{verified/assets/ch10/fig-10-1.png}
...
\subsubsection{10.1.3　Walsh 分析的数学美}\label{ch10-walsh-ux5206ux6790ux7684ux6570ux5b66ux7f8e}
...
\subsection{10.2　Walsh 函数代数化}\label{ch10-walsh-ux51fdux6570ux4ee3ux6570ux5316}

本节将限定在区间 \([0,1)\) 上考察 Walsh 函数。由于自变量 \(x\) 在实际应用中通常代表时间，因此称区间 \([0,1)\) 为\textbf{时基}。

\subsubsection{10.2.1　时基上的二分集}\label{ch10-ux65f6ux57faux4e0aux7684ux4e8cux5206ux96c6}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.2（原图裁切）：时基上的二分集}]{verified/assets/ch10/fig-10-2.png}
...
\subsubsection{10.2.2　Walsh 函数的矩阵表示}\label{ch10-walsh-ux51fdux6570ux7684ux77e9ux9635ux8868ux793a}
...
\subsection{10.3　Walsh 阵的二分演化}\label{ch10-walsh-ux9635ux7684ux4e8cux5206ux6f14ux5316}

现在的问题是，能否设计出某种简单的二分手续，以将方波 \(W_1=[+]\) 逐步演化

\clearpage

原书 PDF 页 266；印刷页码 253。
...
\subsubsection{10.3.1　矩阵的对称性复制}\label{ch10-ux77e9ux9635ux7684ux5bf9ux79f0ux6027ux590dux5236}
...
\subsubsection{10.3.2　Walsh 阵的演化生成}\label{ch10-walsh-ux9635ux7684ux6f14ux5316ux751fux6210}
...
\subsubsection{10.3.3　Walsh 阵的演化机制}\label{ch10-walsh-ux9635ux7684ux6f14ux5316ux673aux5236}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.3（原图裁切）：Walsh 阵的二分演化机制}]{verified/assets/ch10/fig-10-3.png}
...
\subsubsection{10.3.4　Hadamard 阵的演化生成}\label{ch10-hadamard-ux9635ux7684ux6f14ux5316ux751fux6210}
...
原书 PDF 页 269；印刷页码 256。

\href{source-images/pdf-269.jpeg}{原页}

\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.4（原图裁切）：Hadamard 阵的二分演化机制}]{verified/assets/ch10/fig-10-4.png}
...
\subsubsection{10.4.1　FWT 的设计思想}\label{ch10-fwt-ux7684ux8bbeux8ba1ux601dux60f3}
...
原书 PDF 页 271；印刷页码 258。

\href{source-images/pdf-271.jpeg}{原页}

计快速变换的全过程。

\subsubsection{10.4.2　FWT 的演化机制}\label{ch10-fwt-ux7684ux6f14ux5316ux673aux5236}
...
\begin{quote}
校注（agent 补充，CH10-E001）：本页化简式及其后两个 \(N/2\)-WT 的第二式，原图均写作 \(H_{N/2}(N/2+i,j)\)，上文已照录。按前页定理 10.1 和本章对 \(N/2\) 阶矩阵的索引范围，这里的行指标 \(N/2+i\) 超出 \(0,\ldots,N/2-1\)；由 \(H_N(N/2+i,j)=H_{N/2}(i,j)\)，两处应为 \(H_{N/2}(i,j)\)。这是原书下标疑误，不是 OCR 错误。\href{verified/assets/ch10/erratum-p271-indices.png}{原式放大裁片}。此外，本页``定理 1''照录，所用递推关系对应前页``定理 10.1''。
\end{quote}

\clearpage

原书 PDF 页 272；印刷页码 259。
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.5（原图裁切）：FWT 的二分演化模式}]{verified/assets/ch10/fig-10-5.png}
...
\subsubsection{10.4.3　FWT 的计算流程}\label{ch10-fwt-ux7684ux8ba1ux7b97ux6d41ux7a0b}

二分手续（10.4.2）采取两两加工的处理方式，即将一对数据 \((x(j),x(N/2+j))\) 加工成一对新的数据 \((x_1(j),x_1(N/2+j))\)，其计算格式如图 10.6 所示。这里分别用实线与虚线区分数据的相加与相减两种运算。

\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.6（原图裁切）：两两加工的计算格式}]{verified/assets/ch10/fig-10-6.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.7（原图裁切）：8-WT 经第一步化成两个 4-WT}]{verified/assets/ch10/fig-10-7.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.8（原图裁切）：两个 4-WT 经第二步化成四个 2-WT}]{verified/assets/ch10/fig-10-8.png}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 10.9（原图裁切）：8-WT 的完整数据加工流程}]{verified/assets/ch10/fig-10-9.png}
...
\subsubsection{10.4.4　FWT 的算法实现}\label{ch10-fwt-ux7684ux7b97ux6cd5ux5b9eux73b0}
...
\begin{quote}
校注（agent 补充，CH10-E004）：式（10.4.4）原印 \(l=1,2,\cdots,2^k\)，上文照录。此式用 \((l-1)N_{k-1}\) 定位第 \(k-1\) 步的数据段，该步只有 \(2^{k-1}\) 段，因此上限应为 \(2^{k-1}\)。例如 \(N=8,k=1\) 时，按原印取 \(l=2\) 会访问从索引 8 开始的数据，越过 \(0,\ldots,7\)。本页前文用于描述第 \(k\) 步结果分段数的 \(2^k\) 则正确。下一页算法 10.1 引用此式，也受该范围疑误影响。\href{verified/assets/ch10/erratum-p274-range.png}{原式放大裁片}。
\end{quote}

\clearpage

原书 PDF 页 275；印刷页码 262。
...
\subsection{小结}\label{ch10-ux5c0fux7ed3}
