...
\subsection{5.5 线性多步法}\label{ch05b-ux7ebfux6027ux591aux6b65ux6cd5}
...
\subsubsection{5.5.1 基于数值积分的构造方法}\label{ch05b-ux57faux4e8eux6570ux503cux79efux5206ux7684ux6784ux9020ux65b9ux6cd5}
...
\subsubsection{5.5.2 Adams 显式格式}\label{ch05b-adams-ux663eux5f0fux683cux5f0f}
...
\subsubsection{5.5.3 Adams 隐式格式}\label{ch05b-adams-ux9690ux5f0fux683cux5f0f}
...
原书 PDF 页 140；印刷页码 127。

\href{source-images/pdf-140.jpeg}{原页}

\subsubsection{5.5.4 Adams 预测-校正系统}\label{ch05b-adams-ux9884ux6d4b-ux6821ux6b63ux7cfbux7edf}
...
\subsubsection{5.5.5 基于 Taylor 展开的构造方法}\label{ch05b-ux57faux4e8e-taylor-ux5c55ux5f00ux7684ux6784ux9020ux65b9ux6cd5}
...
\subsubsection{5.5.6 Milne 格式}\label{ch05b-milne-ux683cux5f0f}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={式（5.5.21）原图局部：右端开头的下标与加号排印异常}]{verified/assets/ch05b/pdf-143-eq521.png}

\clearpage

原书 PDF 页 144；印刷页码 131。
...
\subsubsection{5.5.7 Hamming 格式}\label{ch05b-hamming-ux683cux5f0f}
...
\subsection{5.6 方程组与高阶方程的情形}\label{ch05b-ux65b9ux7a0bux7ec4ux4e0eux9ad8ux9636ux65b9ux7a0bux7684ux60c5ux5f62}

\subsubsection{5.6.1 一阶方程组}\label{ch05b-ux4e00ux9636ux65b9ux7a0bux7ec4}
...
\subsubsection{5.6.2 化高阶方程组为一阶方程组}\label{ch05b-ux5316ux9ad8ux9636ux65b9ux7a0bux7ec4ux4e3aux4e00ux9636ux65b9ux7a0bux7ec4}
...
\subsection{5.7 边值问题的数值解法}\label{ch05b-ux8fb9ux503cux95eeux9898ux7684ux6570ux503cux89e3ux6cd5}

在具体求解微分方程时，必须附加某种定解条件。微分方程和定解条件一起组成定

\clearpage

原书 PDF 页 148；印刷页码 135。
...
\subsubsection{5.7.1 试射法}\label{ch05b-ux8bd5ux5c04ux6cd5}
...
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={图 5.5（原图）试射法示意}]{verified/assets/ch05b/figure-5-5.png}
...
\subsubsection{5.7.2 差分方程的建立}\label{ch05b-ux5deeux5206ux65b9ux7a0bux7684ux5efaux7acb}
...
\subsubsection{5.7.3 差分问题的可解性}\label{ch05b-ux5deeux5206ux95eeux9898ux7684ux53efux89e3ux6027}
...
\subsubsection{5.7.4 差分方法的收敛性}\label{ch05b-ux5deeux5206ux65b9ux6cd5ux7684ux6536ux655bux6027}
...
原书 PDF 页 153；印刷页码 140。

\href{source-images/pdf-153.jpeg}{原页}

\subsection{小结}\label{ch05b-ux5c0fux7ed3}
...
\subsection{习题}\label{ch05b-ux4e60ux9898}
