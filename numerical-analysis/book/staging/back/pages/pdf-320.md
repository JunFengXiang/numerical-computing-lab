...
**9.** $\omega=1.03$ 时迭代五次达到精度要求 $\boldsymbol{x}^{(5)}=(0.500\,004\,3,0.100\,000\,1,-0.499\,999\,9)^{\mathrm{T}}$，$\omega=1$ 时迭代 $6$ 次达到精度要求 $\boldsymbol{x}^{(6)}=(0.500\,003\,8,0.100\,000\,2,-0.499\,999\,5)^{\mathrm{T}}$，$\omega=1.1$ 时迭代 $6$ 次达到精度要求，$\boldsymbol{x}^{(6)}=(0.500\,003\,5,0.999\,998\,9,-0.500\,000\,3)^{\mathrm{T}}$。

**10.** $\omega=0.9$，迭代 $8$ 次时达到精度要求，$\boldsymbol{x}^{(8)}=(-4.000\,027,0.299\,998\,9,0.200\,000\,3)^{\mathrm{T}}$。
