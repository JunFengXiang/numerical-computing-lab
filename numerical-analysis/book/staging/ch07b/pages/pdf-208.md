...
> 校注（agent 补充，原书疑误）：原文印作 $\operatorname{cond}(H_6)=2.9\times10^6$，这里保留。沿用本例的 $\infty$-范数，对 $6\times6$ Hilbert 矩阵作有理数精确运算得到 $\|H_6\|_\infty\|H_6^{-1}\|_\infty=29\,070\,279\approx2.9\times10^7$，原书指数疑应为 7。[原文局部图](../assets/208-h6-cond.png)。
