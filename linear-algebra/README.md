...
按课程讲次学习。上传的目录对应 Trefethen 与 Bau 的《Numerical Linear Algebra》（1997）；这里的中文 PDF、HTML 是本次提供的学习资料，原文件内容未修改。
...
[完整课程目录](materials/contents.pdf)

第 1、2 讲提供了简短笔记和可运行的入门实验；它们不代表作业已完成。
